...
\author[March'15]{Rashmi Rekha Mech \\
...
\begin{itemize}
  ...
  \item Requirements
  \begin{itemize}
   \item Present Architectures
   \item Required Architecture
  \end{itemize}

  \item Incremental Analysis in details
%   \item Requirements to implement Incremental analysis in PRISM
  \end{itemize}
}
...
\begin{itemize}
 ...
 \item Recomputation is required
\end{itemize}
...
\begin{itemize}
 ...
 \item Need an incremental analysis:
      \begin{itemize}
       ...
       \item more cost effective then \textbf{exhaustive} analysis in terms of space and time
      \end{itemize}
\end{itemize}
}
...
\frame{
\frametitle{Present Architecture of PRISM}
\onslide<1->
\psset{unit=1mm}
\psset{linewidth=.3mm}
\psset{framearc=.1}
\begin{pspicture}(25,-25)(38,64)
 \putnode{n0}{origin}{50}{50}{Program} 

\onslide<2->
\putnode{n1}{n0}{40}{0}{\psframebox{IR generator} }
\ncline{->}{n0}{n1}

\onslide<3->
\putnode{n2}{n0}{70}{0}{IR} 
\ncline{->}{n1}{n2}

\onslide<4->
\putnode{n3}{n0}{70}{-25}{\psframebox{Generated analyzer} }
\ncline{->}{n2}{n3}

\onslide<5->
\putnode{n7}{n3}{-80}{-10}{.java files}
\putnode{n6}{n3}{-80}{10}{.klg files}
...
\onslide<9->
\putnode{n4}{n0}{70}{-50}{Output reports}
\ncline{->}{n3}{n4}

\onslide<10->
\putnode{n5}{n2}{20}{-10}{\psframebox{\red Old IR}}
\ncline{->}{n5}{n3}
\end{pspicture}
}
\frame{
\frametitle{Present architecture of analyser generator}
\onslide<1->
\psset{unit=1mm}
\psset{linewidth=.3mm}
\psset{framearc=.1}
...
\frame{
\frametitle{Required architecture of analyser generator}
\onslide<1->
\psset{unit=1mm}
\psset{linewidth=.3mm}
\psset{framearc=.1}
...
\onslide<2->
\putnode{n3}{n1}{55}{-5}{%
     \psframebox[linewidth=.3,framesep=1.7]{Detect changed nodes}}
...
\onslide<4->
\putnode{n4}{n3}{0}{-15}{%
     \psframebox[linewidth=.3,framesep=1.7]{Detect affected region}}
...
\onslide<6->
\putnode{n5}{n4}{0}{-15}{%
     \psframebox[linewidth=.3,framesep=1.7]{Compute Boundary nodes}}
...
\onslide<8->
\putnode{n6}{n5}{0}{-15}{%
     \psframebox[linewidth=.3,framesep=1.7]{Update Old Solution}}
...
\putnode{n13}{n6}{45}{0}{%
      \psframebox[linewidth=.3,framesep=1.7]{Old Solution}}
...
\onslide<12->
\putnode{n11}{n5}{0}{0}{%
      \psframebox[linestyle=dashed, linecolor=red, linewidth=.3,framesep=23.7]{}}

\putnode{n12}{n10}{20}{5}{%
      \textbf{\red Solver}}
...
% 
% \frame{ 
% \frametitle{Architecture of Analyser generator}
% \onslide<1->
% \psset{unit=1mm}
% \psset{linewidth=.3mm}
% \psset{framearc=.1}
...
% % \psframe(-20,10)(105,80)
% 
% \putnode{n2}{origin}{60}{30}{%
%      \psframebox[linewidth=.3,framesep=3.7]{Solver}}
% 
%     
% \onslide<2->    
%   
...
% \onslide<4->
% \putnode{n8}{n2}{-40}{0}{%
%      \psframebox[linewidth=.3,framesep=1.7]{Compute Affected region}}
% \onslide<5->
% \ncline{->}{n1}{n8}
% \ncline{->}{n7}{n8}
% 
...
% To implement incremental analysis in PRISM we need:
% \begin{itemize}
%  \item old data flow information
%  \item how to read old data flow information
% \end{itemize}
% 
% }


\part{Incremental analysis in details}
\frame{\partpage}


\frame{
\frametitle{Flow functions in Bit-vector framework}
\begin{itemize}
 \item Possible flow functions:
	\begin{itemize}
	 \item Raise : Results is always Top
	 \item Lower : Results is always Bottom
...
\frame{ 
\frametitle{Changes in Bit-vector framework}
\begin{itemize}
...
\frame{ 
\frametitle{Possible changes in flow functions for bottom to top change}
\begin{pspicture}(0,10)(0,40)
\putnode{n1}{origin}{45}{30}{%
     \psframebox[linewidth=.3,framesep=2.5]{lower}}
 \putnode{a}{n1}{0}{10}{\textit{old}}
...
\begin{itemize}
 ...
 \begin{itemize}
 \onslide<2->
  \item Identify the data flow values which may becomes top
  \onslide<3->
...
\begin{itemize}
 \item Find out the data flow values which must remain bottom due to the effect of some other property
 \begin{itemize}
 \item<2-> Identifying Boundary nodes
 \item<3-> Computing values at boundary nodes and propagating them
 \end{itemize}
\end{itemize}
}
