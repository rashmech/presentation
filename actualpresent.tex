...
\author[Oct'14]{Rashmi Rekha Mech \\
...
\begin{itemize}
  ...
  \begin{itemize}
  \item Bit-vector framework
  \item Constant Propagation analysis 
  \end{itemize}
  \item Overview of PRISM 
  \item Liveness-based Reaching Definition analysis
  \begin{itemize}
...
\part{Incremental Analysis in Constant Propagation}
\frame{\partpage}
...
\begin{itemize}
\item When there is a change to bottom:
\begin{itemize}
 \item No need of creating affected region 
...
\frame{
\frametitle{Architecture of PRISM}
\onslide<1->
\psset{unit=1mm}
\psset{linewidth=.3mm}
\psset{framearc=.1}
