...
\begin{itemize}
  ...
  \item Incremental Driver for PRISM
  \begin{itemize}
    \item Architecture
    \item Testing
   \end{itemize}
...
\begin{itemize}
 \item Due to program change, following changes are possible\footnote {Following slides talk about a change in flow function}:
 \begin{itemize}
