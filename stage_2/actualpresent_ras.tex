...
\begin{itemize} \setlength \itemsep{1em}
  ...
  \item Incremental Solver for PRISM
  \begin{itemize} \setlength \itemsep{1em}
    \item Architecture
    \item Testing
   \end{itemize}
...
\begin{itemize} \setlength \itemsep{1em}
 \item Some or all computed data flow information becomes invalid
...
\item May unnecessarily analyze unaffected program behaviours which leads to redundant computation of old values which is very inefficient.
 \item Need an incremental analysis:
      \begin{itemize} \setlength \itemsep{1em}
       \item modifies only affected data flow information
       \item more cost effective than \textbf{exhaustive} analysis
      \end{itemize}
\end{itemize}
}


\part{Incremental Analysis for Bit-vector Frameworks}
\frame{\partpage}

\frame{ 
\frametitle{Possible changes}
\begin{itemize} \setlength \itemsep{1em}
 \item Due to program change, the following changes are possible\footnote {Following slides talk about a change in flow function}:
 \begin{itemize} \setlength \itemsep{1em}
  \item Change in flow functions
  \item Change in control flow graph
  \item Change in lattice
 \end{itemize}
...
\putnode{x1}{n1}{90}{-5}{1}
\putnode{x3}{x1}{0}{-2}{}
\putnode{x2}{x1}{0}{-20}{0}
\putnode{x4}{x2}{0}{2}{}
\putnode{b1}{x1}{0}{4}{$(\top)$}
\putnode{b2}{x2}{0}{-4}{$(\bot)$}
\ncline{-}{x3}{x4}
\putnode{l}{x1}{0}{9}{\textbf{Lattice}}
...
\onslide<2-3>
\putnode{a1}{n1}{35}{0}{\textbf{Raise Function}}
...
\frame{ 
\frametitle{Possible Changes in Data Flow Values}
\begin{itemize} \setlength \itemsep{1em}
...
\frame{ 
\frametitle{Top to Bottom Change}
\begin{itemize} \setlength \itemsep{1em}
 \item Possible changes in flow functions.
\end{itemize}
...
\onslide<1-4>
\putnode{x}{n1}{5}{17}{\blue Available Expression Analysis (Initial data flow values)}
...
\begin{itemize} \setlength \itemsep{1em}
 ...
 \begin{itemize} \setlength \itemsep{1em}
 \onslide<2->
  \item Identify data flow values which may become top
  \onslide<3->
...
\begin{itemize} \setlength \itemsep{1em}
 \item To identify data flow values which were 0 and \textit{may} become 1 due to this change
 \begin{itemize} \setlength \itemsep{1em}
...
\begin{itemize} \setlength \itemsep{1em}
 \item To identify data flow values which must remain bottom due to the effect of some other properties
 \begin{itemize} \setlength \itemsep{1em}
...
\part{Incremental Analysis for General Frameworks}
\frame{\partpage}


\frame{
\frametitle{Incremental Analysis for General Frameworks}
\begin{itemize} \setlength \itemsep{1em}
 \item Consider constant propagation analysis 
 \item Component Lattice for Constant Propagation:
 \end{itemize}
...
\putnode{x}{n1}{35}{-80}{\red Produce constant value}
...
\frametitle{Method to Reduce the Size of Affected Region}
\begin{itemize} \setlength \itemsep{1em}
 \item All Dominance frontier nodes are boundary nodes (but not vice versa). 
 \end{itemize}
...
\frametitle{Method to Reduce the Size of Affected Region}
\begin{itemize} \setlength \itemsep{1em}
 \item Possible removal candidates must be dominance frontier of changed node.
\end{itemize}
}
...
\rput(39,74){\rnode{a2}{\blue$\langle b=2 \rangle$}}
...
\onslide<2-2>
\putnode{u}{n3}{40}{0}{\red {AR: $<n_5, n_6, n_3, n_4>$}}
...
\frametitle{Method to Reduce the Size of Affected Region}
\begin{itemize} \setlength \itemsep{1em}
 \item Also applicable for bit-vector frameworks.
\end{itemize}
...
\part{Incremental Solver for PRISM}
\frame{\partpage}

\frame{
\frametitle{Architecture of Incremental Solver for PRISM}
\begin{itemize} \setlength \itemsep{1em}
 \item Architecture of incremental solver for PRISM is divided into following parts:
 \begin{itemize} \setlength \itemsep{1em}
  \item Preprocessing: reads two IRs and find the difference between them.
  \item Data Flow Computation: 
	\begin{itemize} \setlength \itemsep{1em}
	 \item Re-initialization: constructs affected region.
	 \item Re-computation: identify boundary nodes and compute the information.
	\end{itemize}
  \item Update: merge the information.
...
\begin{itemize} \setlength \itemsep{1em}
 ...
 \item Declaration of variable hasn't change.
 \item The result of old solver is stored in non-standard format. So the following assumptions are made:
 \begin{itemize} \setlength \itemsep{1em}
...
\begin{itemize} \setlength \itemsep{1em}
 \item Following are current limitations:
\begin{itemize} \setlength \itemsep{1em}
 \item Code for affected region has to be written manually.
 \item Result is stored in a non-standard format by the Solver. 
 \item Non inclusion of global and local declarations.

\end{itemize}
 \item These can be overcome.
\end{itemize}
...
\frametitle{Testing}
\begin{itemize} \setlength \itemsep{1em}
 \item In the absence of serialization of IR, it was not possible to test the code in real world applications.
 \item Artificially added the changes to check the performance of the incremental solver.
\end{itemize}
...
%  \psframe(0,0)(130,80)
\onslide<1->
\putnode{n1}{origin}{25}{67}{%
      \psframebox[linewidth=.3,framesep=1.0, framearc=.3]{\hspace{5mm}}}
%  \rput(10,67){\rnode{a}{\tiny{n1}}}  
\putnode{n}{n1}{30}{10}{{\red{$n7$ is a changed node}}}
\putnode{a}{n1}{0}{3}{\tiny{main}}
\putnode{a1}{n1}{-5}{0}{\tiny{n1}}
\putnode{n2}{n1}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{if( )}}}
\putnode{a2}{n2}{-5}{0}{\tiny{n2}}

\putnode{n3}{n2}{10}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{while( )}}}
\putnode{a3}{n3}{-6}{0}{\tiny{n3}}

\putnode{n4}{n3}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{z = 1}}}
\putnode{a4}{n4}{-5}{0}{\tiny{n4}}

\putnode{n5}{n4}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{if( )}}}
\putnode{a5}{n5}{-5}{0}{\tiny{n5}}

\putnode{n6}{n5}{-9}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{if( )}}}
\putnode{a6}{n6}{-4}{0}{\tiny{n6}}
 
\putnode{n7}{n5}{15}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{a =}}}
...
\putnode{n11}{n9}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{func( )}}}

 
\putnode{n8}{n6}{9}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{z =}}}
\putnode{a8}{n8}{-5}{0}{\tiny{n8}}
 
\putnode{n10}{n8}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{func1( )}}}
\putnode{a10}{n10}{-7}{0}{\tiny{n10}}

\putnode{n12}{n10}{5}{-7}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{a =}}}
\putnode{a12}{n12}{-5}{0}{\tiny{n12}}

\putnode{n13}{n6}{-7}{-10}{%
 \psframebox[linewidth=.3,framesep=1, framearc=.3]{\hspace{5mm}}}
\putnode{a13}{n13}{-6}{0}{\tiny{n13}}

\putnode{n14}{n13}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=1, framearc=.3]{\hspace{5mm}}}
\putnode{a14}{n14}{-6}{0}{\tiny{n14}}
...
\putnode{n15}{origin}{85}{67}{%
     \psframebox[linewidth=.3,framesep=1]{ \hspace{5mm}}}
     \putnode{m15}{n15}{0}{3}{\tiny{func( )}}


\putnode{n160}{n15}{0}{-5}{%
     \psframebox[linewidth=.3,framesep=1]{\tiny{$a=$}}}


\putnode{n17}{n160}{0}{-5}{%
     \psframebox[linewidth=.3,framesep=1]{\hspace{5mm}}}
\putnode{a17}{n17}{-6}{0}{\tiny{n17}}
 
\putnode{n18}{n17}{-9}{-5}{%
     \psframebox[linewidth=.3,framesep=1]{\hspace{5mm}}}
\putnode{a18}{n18}{-6}{0}{\tiny{n18}}

\putnode{n19}{n17}{9}{-5}{%
     \psframebox[linewidth=.3,framesep=1]{\hspace{5mm}}}
\putnode{a19}{n19}{-6}{0}{\tiny{n19}}

\putnode{n20}{n17}{0}{-10}{%
     \psframebox[linewidth=.3,framesep=1]{\hspace{5mm}}}
\putnode{a20}{n20}{-6}{0}{\tiny{n20}}
...
\ncline{->}{n18}{n20}
\ncline{->}{n20}{n00}
\ncloop[armA=1.5,armB=1.5,angleA=-90,angleB=90,loopsize=-14,
		linearc=0.5,offsetA=1, offsetB=1]{->}{n20}{n17}
		
% \rput(120,125){\rnode{f2}{func1()}}
\putnode{n21}{origin}{85}{30}{%
     \psframebox[linewidth=.3,framesep=1.0]{ \hspace{5mm}}}
\putnode{m21}{n21}{0}{3}{\tiny{func1(m)}}
\putnode{a21}{n21}{-6}{0}{\tiny{n21}}

\putnode{n22}{n21}{0}{-5}{%
     \psframebox[linewidth=.3,framesep=1.0]{\hspace{5mm}}}
\putnode{a22}{n22}{-6}{0}{\tiny{n22}}

\putnode{n23}{n22}{-7}{-5}{%
     \psframebox[linewidth=.3,framesep=1.0]{\hspace{5mm}}}
\putnode{a23}{n23}{-6}{0}{\tiny{n23}}

\putnode{n24}{n22}{7}{-5}{%
     \psframebox[linewidth=.3,framesep=1.0]{\hspace{5mm}}}
\putnode{a24}{n24}{-6}{0}{\tiny{n24}}

\putnode{n25}{n22}{0}{-10}{%
     \psframebox[linewidth=.3,framesep=0.3]{\tiny{$m=$}}}
\putnode{a25}{n25}{-6}{0}{\tiny{n25}}

\putnode{n26}{n25}{0}{-5}{%
     \psframebox[linewidth=.3,framesep=1.0]{\hspace{5mm}}}
\putnode{a26}{n26}{-6}{0}{\tiny{n26}}
...
\onslide<1-2>
\putnode{a7}{n7}{-5}{0}{\tiny{n7}}
\putnode{a9}{n9}{-5}{0}{\tiny{n9}}
\putnode{a11}{n11}{-7}{0}{\tiny{n11}}		
\putnode{a15}{n15}{-6}{0}{\tiny{n15}}
\putnode{a16}{n160}{-5}{0}{\tiny{n16}}

\onslide<2->
\putnode{x1}{n7}{0}{0}{\red{\tiny{$a=$}}}

\onslide<3->
\putnode{a7}{n7}{-5}{0}{\red{\tiny{n7}}}
\putnode{a9}{n9}{-5}{0}{\red{\tiny{n9}}}
\putnode{a11}{n11}{-7}{0}{\red{\tiny{n11}}}		
\putnode{a15}{n15}{-6}{0}{\red{\tiny{n15}}}
\putnode{a16}{n160}{-5}{0}{\red{\tiny{n16}}}
...
\putnode{a9}{n9}{-5}{0}{\red{\tiny{n9}}}
\putnode{a11}{n11}{-7}{0}{\red{\tiny{n11}}}		
\putnode{a12}{n12}{-5}{0}{\red{\tiny{n12}}}
...
\putnode{n1}{origin}{25}{67}{%
      \psframebox[linewidth=.3,framesep=1.0, framearc=.3]{\hspace{5mm}}}
%  \rput(10,67){\rnode{a}{\tiny{n1}}}  
\putnode{n}{n1}{30}{10}{{\red{$n8$ is a changed node}}}
\putnode{a}{n1}{0}{3}{\tiny{main}}
\putnode{a1}{n1}{-5}{0}{\tiny{n1}}
\putnode{n2}{n1}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{if( )}}}
...
\putnode{n10}{n8}{0}{-5}{%
 \psframebox[linewidth=.3,framesep=0.3, framearc=.3]{\tiny{func1(z)}}}
...
\onslide<2->
\putnode{x1}{n8}{0}{0}{\red{\tiny{$z=$}}}

\onslide<3->
\putnode{a8}{n8}{-5}{0}{\red{\tiny{n8}}}
\putnode{a10}{n10}{-7}{0}{\red{\tiny{n10}}}
\putnode{a21}{n21}{-6}{0}{\red{\tiny{n21}}}
\putnode{a22}{n22}{-6}{0}{\red{\tiny{n22}}}
\putnode{a23}{n23}{-6}{0}{\red{\tiny{n23}}}
\putnode{a24}{n24}{-6}{0}{\red{\tiny{n24}}}
\putnode{a25}{n25}{-6}{0}{\red{\tiny{n25}}}
\putnode{a12}{n12}{-5}{0}{\red{\tiny{n12}}}
\putnode{a3}{n3}{-6}{0}{\red{\tiny{n3}}}
\putnode{a4}{n4}{-5}{0}{\red{\tiny{n4}}}
...
\begin{itemize} \setlength \itemsep{1em}
 \item Change the Kulang compiler to generate the code to compute affected region from the flow function.
 \item Extending the method of reducing the size of affected region for multiple changes.
 \item Persist the result of the solver.
