...
\begin{itemize}
  ...
  \item Incremental Analysis for Bit-vector Frameworks
  \item Incremental Analysis for General Frameworks
...
\part{Incremental Analysis for Bit-vector Framework}
\frame{\partpage}
...
\begin{itemize}
 \item Change the Kulang compiler to generate the affected region from the flow function.
